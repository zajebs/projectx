<div class="">
    <div class="review-text-title">{{ __('you dont have account') }}</div>
    <div class="review-text-decription">
        {{ __('first create a account to write down a review to seller accoount') }}
    </div>
    <div class="mt-24">
    ...
    @if (config('zakirsoft.google_active') ||
            config('zakirsoft.linkedin_active') ||
            config('zakirsoft.facebook_active') ||
            config('zakirsoft.twitter_active') ||
            config('zakirsoft.github_active') ||
            config('zakirsoft.gitlab_active') ||
            config('zakirsoft.bitbucket_active'))
        <div class="mt-24 d-flex-custom flex-wrap align-items-center">
            <div class="or-text">{{ __('or sign up with') }}</div>
