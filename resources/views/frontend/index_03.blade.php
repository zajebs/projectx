...
@section('content')
    ...
    <div class="banner banner--three" style="background:url('') center center/cover no-repeat;">
        <div class="container">
            <span class="banner__tag text--body-2-600">{{ __('over') }} {{ $totalAds }} {{ __('live ads') }}</span>
    ...
    <section class="section popular-category">
        <div class="container">
            <h2 class="text--heading-1 section__title">{{ __('popular category') }}</h2>
            <div class="row">
                        ...
                        <div class="category-card">
                            ...
                            <div class="category-card__view">
                                ...
                                <a href="javascript:void(0)" onclick="adFilterFunction('{{ $category->slug }}')"
                                    ...
                                    {{ __('view ads') }}
                                    <span class="icon">
                                        <x-svg.right-arrow-icon stroke="#070707" />
                                    </span>
                                </a>
                            </div>
                        </div>
    ...
    @if ($settings->featured_ads_homepage)
        <section class="section recent-post">
            <div class="container">
                <h2 class="text--heading-1 section__title">{{ __('featured ads') }}</h2>
                <div class="row">
    ...
    @if ($settings->regular_ads_homepage)
        <section class="section recent-post">
            <div class="container">
                <h2 class="text--heading-1 section__title">{{ __('regular ads') }}</h2>
                <div class="row">
