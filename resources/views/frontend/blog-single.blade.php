...
@section('content')
    ...
    <section class="section single-blog">
        <div class="container">
            <div class="single-blog__lg-img-wrapper">
                <img src="{{ getPhoto($blog->image) }}" alt="blog-img" class="img-fluid">
            </div>
                    ...
                    <div class="single-blog__blog-content">
                        <ul class="single-blog__info">
                            <li class="single-blog__info-item">
                                <span class="icon">
                                    <i class="{{ $blog->category->icon ?? '' }}" style="color: #070707"></i>
                                </span>
                        ...
                        <div class="single-blog__author-info">
                            <div class="author-img">
                                <div class="img">
                                    <img src="{{ getPhotoAvater($blog->author->image) }}" alt="author-img">
                                </div>
    ...
    {{ (App::getLocale() === 'lv') ? $category->name_lv : $category->name }}
                            ...
                            <div class="blog__sidebar-post blog__sidebar-item">
                                <h2 class="text--body-2-600 item-title">{{ __('recent post') }}</h2>
                                <div class="post">
