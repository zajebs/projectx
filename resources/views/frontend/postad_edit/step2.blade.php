...
@section('title')
    {{ __('edit ad') }} ({{ __('steps02') }}) - {{ $ad->title }}
@endsection
    ...
    <div class="tab-pane fade show active" id="pills-post" role="tabpanel" aria-labelledby="pills-post-tab">
        <div class="dashboard-post__ads step-information">
            ...
            <form id="step2_edit_form" action="{{ route('frontend.post.step2.update', $ad->slug) }}" method="POST"
                ...
                @csrf
                @method('PUT')
                {{-- <input type="hidden" class="d-none" name="category" value="{{ $ad->category_id }}">
                <input type="hidden" class="d-none" name="subcategory_id" value="{{ $ad->subcategory_id }}">
                <input type="hidden" class="d-none" name="child_category" value="{{ $ad->child_category_id }}"> --}}
                        ...
                        <div class="input-field__group">
                            <div class="input-field">
                                ...
                                <input name="address" id="address" type="text" class="" placeholder=""
                                    value="{{ old('address') ?? $ad->address }}" required />
                                @error('address')
                        ...
                        <div class="input-field__group">
                            <div class="input-field">
                                ...
                                <input name="city" id="city" type="text" class="" placeholder=""
                                    value="{{ old('city') ?? $ad->city }}" required />
                                @error('city')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="input-field__group">
                            <div class="input-field">
                                ...
                                <input name="state" id="state" type="text" class="" stateholder=""
                                    value="{{ old('state') ?? $ad->state }}" required />
                                @error('state')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                                ...
                                <select name="country" id="" required>
                                    ...
                                    @foreach ($locations as $location)
                                        <option {{ $ad->country == $location->id ? 'selected' : '' }}
                                            value="{{ $location->id }}">{{ $location->locations }}</option>
                                    @endforeach
                                </select>
                                @error('country')
                                    <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="input-field__group">
                            <div class="input-field">
                                ...
                                <input name="postcode" id="postcode" type="text" class="" placeholder=""
                                    value="{{ old('postcode') ?? $ad->postcode }}" required />
                                @error('postcode')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
