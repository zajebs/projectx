<form class="form-horizontal" action="{{ route('admin.errorpages.update') }}" method="POST"
    ...
    <div class="row justify-content-between">
        <div class="col-md-6">
            ...
            <div class="form-group">
                <x-forms.label name="e404 subtitle" />
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                <x-forms.label name="e500 subtitle" />
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                <x-forms.label name="e503 subtitle" />
    ...
    <div class="row mt-3 text-center justify-content-center">
        <div class="col-8 offset-1 ">
            <button type="submit" class="btn btn-success">
                <i class="fas fa-sync"></i> {{ __('update content') }}
            </button>
        </div>
    </div>
</form>
