<form class="form-horizontal" action="{{ route('admin.dashboard.update') }}" method="POST"
    ...
    <div class="row justify-content-between">
        <div class="col-md-3">
            <div class="form-group">
                <x-forms.label name="dashboard overview background" />
                <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group">
                <x-forms.label name="dashboard post ads background" />
                <div class="row">
                    <input type="file" class="form-control dropify"
        ...
        <div class="col-md-3">
            <div class="form-group">
                <x-forms.label name="dashboard my ads background" />
                <div class="row">
                    <input type="file" class="form-control dropify"
    ...
    <div class="row justify-content-between">
        <div class="col-md-3">
            <div class="form-group">
                <x-forms.label name="dashboard favorite ads background" />
                <div class="row">
                    <input type="file" class="form-control dropify"
        ...
        <div class="col-md-3">
            <div class="form-group">
                <x-forms.label name="dashboard messenger background" />
                <div class="row">
                    <input type="file" class="form-control dropify"
        ...
        <div class="col-md-3">
            <div class="form-group">
                <x-forms.label name="dashboard plan background" />
                <div class="row">
                    <input type="file" class="form-control dropify"
    ...
    <div class="row ">
        <div class=" col-md-3">
            <div class="form-group">
                <x-forms.label name="dashboard account setting background" />
                <div class="row">
                    <input type="file" class="form-control dropify"
