<div class="col-lg-6 order-1 order-lg-0">
    <div class="registration-form">
        <h2 class="text-center text--heading-1 registration-form__title">{{ __('sign in') }}</h2>
        {{-- Social Login --}}
        <x-auth.social-login />
            ...
            <form action="{{ route('frontend.login') }}" method="POST">
                ...
                <div class="registration-form__option">
                    ...
                    <div class="registration-form__forget-pass text--body-4">
                        <a href="{{ route('customer.forgot.password') }}">{{ __('forget password') }}</a>
                    </div>
                </div>
                ...
                <p class="text--body-3 registration-form__redirect">{{ __('dont have account') }} ? <a
                        href="{{ route('frontend.signup') }}">{{ __('sign up') }}</a></p>
            </form>
        </div>
    </div>
</div>
