    ...
    <div class="registration__features">
        <div class="registration__features-item">
            ...
            <div class="registration__features-info">
                <h2 class="text--body-2-600">{{ __('manage your ads') }}</h2>
                <p class="text--body-3">
        ...
        <div class="registration__features-item">
            ...
            <div class="registration__features-info">
                <h2 class="text--body-2-600">{{ __('chat with anyone anytime') }}</h2>
                <p class="text--body-3">
                    {{ $cms->chat_content }}
                </p>
            </div>
        ...
        <div class="registration__features-item">
            ...
            <div class="registration__features-info">
                <h2 class="text--body-2-600">{{ $verifiedusers }} {{ __('verified user') }}</h2>
                <p class="text--body-3">
