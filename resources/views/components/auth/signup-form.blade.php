<div class="col-lg-6 order-1 order-lg-0">
    <div class="registration-form">
        <h2 class="text-center text--heading-1 registration-form__title">{{ __('sign up') }}</h2>
        {{-- Social Login --}}
        <x-auth.social-login />
        ...
        <div class="registration-form__wrapper">
            <form action="{{ route('customer.register') }}" method="POST">
                ...
                <div class="input-field">
                    <input value="{{ old('name') }}" type="text" placeholder="{{ __('full name') }}" name="name"
                ...
                <div class="registration-form__option">
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="checkme">
                            {{ __('read agree') }} <a
                                href="{{ route('frontend.privacy') }}">{{ __('privacy policy') }}</a>
                            {{ __('and') }}
                ...
                <p class="text--body-3 registration-form__redirect">{{ __('have account') }} ? <a
                        href="{{ route('users.login') }}">{{ __('sign in') }}</a></p>
            </form>
        </div>
    </div>
</div>
