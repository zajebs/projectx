        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="work-card">
                    ...
                    <h2 class="work-card__title text--body-1">{{ __('create account') }}</h2>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="work-card">
                    ...
                    <h2 class="work-card__title text--body-1">{{ __('post ads') }}</h2>
                    <p class="work-card__description text--body-3">
                        {{ $cms->post_ads }}
                    </p>
                </div>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="work-card">
                    ...
                    <h2 class="work-card__title text--body-1">{{ __('start earning') }}</h2>
                    <p class="work-card__description text--body-3">
                        {{ $cms->start_earning }}
                    </p>
                </div>
