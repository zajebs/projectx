             ...
             <div class="col-lg-3 col-sm-6">
                 <div class="counter__item">
                     ...
                     <div class="counter__info">
                         ...
                         <p class="text--body-2 counter__designation">{{ __('published ads') }}</p>
                     </div>
                 </div>
             </div>
             <div class="col-lg-3 col-sm-6">
                 <div class="counter__item">
                     ...
                     <div class="counter__info">
                         ...
                         <p class="text--body-2 counter__designation">{{ __('verified user') }}</p>
                     </div>
                 </div>
             </div>
             <div class="col-lg-3 col-sm-6">
                 <div class="counter__item">
                     ...
                     <div class="counter__info">
                         ...
                         <p class="text--body-2 counter__designation">{{ __('pro members') }}</p>
                     </div>
                 </div>
             </div>
             <div class="col-lg-3 col-sm-6">
