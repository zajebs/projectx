            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('user edit') }}</h3>
                        ...
                        <div class="col-md-6 offset-md-3">
                            <div class="text-center mb-4 pt-2">
                                <img width="150px" height="150px" id="image" class="img-circle"
                                    src="{{ getPhoto($user->image ) }}" alt="{{ __('user profile picture') }}"
                            ...
                            <form class="form-horizontal" action="{{ route('user.update', $user->id) }}" method="POST"
                                ...
                                <div class="form-group row">
                                    <x-forms.label name="{{ __('change password?') }}" class="col-sm-3" />
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <x-forms.label name="{{ __('assign roles') }}" class="col-sm-3" />
                                    <div class="col-sm-9">
                                        <select name="roles[]" class="select2bs4 @error('roles') is-invalid @enderror"
                                            multiple="multiple" data-placeholder="{{ __('select roles') }}" style="width: 100%;">
