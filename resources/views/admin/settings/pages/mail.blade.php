...
@section('website-settings')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title" style="line-height: 36px;">{{ __('mail settings') }}</h3>
        </div>
        <div class="card-body">
            <form action="{{ route('settings.email.update') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="mb-3">
                            <x-forms.label name="{{ __('mail driver') }}" for="driver" />
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            <x-forms.label name="{{ __('mail host') }}" />
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            <x-forms.label name="{{ __('mail port') }}" />
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            <x-forms.label name="{{ __('mail username') }}" />
                            <input type="text" class="form-control @error('mail_username') is-invalid @enderror"
                                id="mail_username" placeholder="{{ __('change mail username') }}" name="mail_username"
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            <x-forms.label name="{{ __('mail password') }}" />
                            <input type="text" class="form-control @error('mail_password') is-invalid @enderror"
                                id="mail_password" placeholder="{{ __('change mail password') }}" name="mail_password"
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            <x-forms.label name="{{ __('mail encryption') }}" />
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            <x-forms.label name="{{ __('mail from address') }}" />
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            <x-forms.label name="{{ __('mail from name') }}" />
