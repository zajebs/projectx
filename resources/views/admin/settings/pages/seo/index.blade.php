                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title" style="line-height: 36px;">{{ __('seo page list') }}</h3>
                            </div>
                                ...
                                <table class="table table-hover text-nowrap table-bordered">
                                    <thead class="text-center">
                                        <tr>
                                            ...
                                            <th> {{ __('page name') }} </th>
                                            <th> {{ __('meta title') }} </th>
                                            <th> {{ __('Meta Title lv') }} </th>
                                            <th> {{ __('meta description') }} </th>
                                            <th> {{ __('Meta description Lv') }} </th>
                                            <th width="15%">{{ __('page review image') }} </th>
                                        ...
                                        @if ($seos->count() > 0)
                                            @foreach ($seos as $seo)
                                                <tr class="text-center">
                                                    ...
                                                    <td>{{ Str::limit($seo->title_lv, 10) }}</td>
                                                    <td>
                                                        {{ Str::limit($seo->description, 15) }}
                                                    </td>
                                                    <td>
                                                        {{ Str::limit($seo->description_lv, 15) }}
                                                    </td>
                                                    <td>
