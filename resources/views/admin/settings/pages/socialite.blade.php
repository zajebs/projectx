    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('google login credentiall') }}</h3>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input
                                        ...
                                        value="{{ env('GOOGLE_CLIENT_SECRET') }}" name="google_client_secret" type="text"
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('facebook login credential') }}</h3>
                        <div class="form-group row">
            ...
            {{-- <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('twitter login credential') }}</h3>
                        <div class="form-group row">
        ...
        <div class="col-sm-6">
            ...
            {{-- <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('linkedin login credential') }}</h3>
                        <div class="form-group row">
            ...
            {{-- <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('github login credential') }}</h3>
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input
                                        ...
                                        value="{{ env('GITHUB_CLIENT_SECRET') }}" name="github_client_secret" type="text"
