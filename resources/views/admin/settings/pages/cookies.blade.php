...
@section('website-settings')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title" style="line-height: 36px;">{{ __('cookies settings') }}</h3>
        </div>
            ...
            <div class="col-md-8 offset-md-2">
                <form class="form-horizontal" action="{{ route('settings.cookies.update') }}" method="POST">
                    ...
                    <div class="form-group row">
                        <x-forms.label for="allow_cookies" name="allow cookies consent" :required="false"
                            class="col-md-4 pt-2" />
                        <div class="col-md-8">
                    ...
                    <div class="form-group row">
                        <x-forms.label for="cookie_name" name="{{ __('cookie name') }}" class="col-md-4" />
                        <div class="col-md-8">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="checkbox" id="force_consent" {{ $cookie->force_consent ? 'checked' : '' }}
                                ...
                                data-off-color="warning" data-off-text="{{ __('no') }}" data-size="large"
                                value="1">
                            <x-forms.error name="force consent" />
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <x-forms.label for="approve_button_text" name="{{ __('approve button text') }}"
                            class="col-md-4" />
                        <div class="col-md-8">
                            <x-forms.input type="text" id="approve_button_text" name="approve_button_text"
                                placeholder="{{ __('enter approve button text') }}"
                                value="{{ $cookie->approve_button_text }}" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <x-forms.label for="decline_button_text" name="{{ __('reject button text') }}"
                            class="col-md-4" />
                        <div class="col-md-8">
                            <x-forms.input type="text" id="decline_button_text" name="decline_button_text"
                                placeholder="{{ __('enter reject button text') }}"
