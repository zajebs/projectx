    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('paypal settings') }}</h3>
                ...
                @if (env('PAYPAL_ACTIVE'))
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('settings.payment.update') }}" method="POST"
                            ...
                            <div class="form-group row">
                                <x-forms.label name="{{ __('live mode') }}" class="col-sm-3" />
                                <div class="col-sm-9">
                            ...
                            @if (env('PAYPAL_MODE') == 'sandbox')
                                <div class="form-group row">
                                    <x-forms.label name="{{ __('client id') }}" class="col-sm-3" />
                                    <div class="col-sm-9">
                                        <input
                                ...
                                <div class="form-group row">
                                    <x-forms.label name="{{ __('client secret') }}" class="col-sm-3" />
                                    <div class="col-sm-9">
                                        <input
            ...
            {{-- <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('ssl commerz settings') }}</h3>
                        <div class="form-group row">
                ...
                @if (env('SSLCOMMERZ_ACTIVE'))
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('settings.payment.update') }}" method="POST"
                            ...
                            <div class="form-group row">
                                <x-forms.label name="{{ __('store id') }}" class="col-sm-3" />
                                <div class="col-sm-9">
                            ...
                            <div class="form-group row">
                                <x-forms.label name="{{ __('store password') }}" class="col-sm-3" />
                                <div class="col-sm-9">
                                    <input
            ...
            {{-- <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('flutterwave settings') }}</h3>
                        <div class="form-group row">
                ...
                @if (env('FLW_ACTIVE'))
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('settings.payment.update') }}" method="POST"
                            ...
                            <div class="form-group row">
                                <x-forms.label name="{{ __('public key') }}" class="col-sm-3" />
                                <div class="col-sm-9">
                                    <input
                            ...
                            <div class="form-group row">
                                <x-forms.label name="{{ __('secret key') }}" class="col-sm-3" />
                                <div class="col-sm-9">
                                    <input
                            ...
                            <div class="form-group row">
                                <x-forms.label name="{{ __('secret hash') }}" class="col-sm-3" />
                                <div class="col-sm-9">
                                    <input
                ...
                @if (config('zakirsoft.im_active'))
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('settings.payment.update') }}" method="POST"
                            ...
                            <div class="form-group row">
                                <x-forms.label name="instamojo key" class="col-sm-3" />
                                <div class="col-sm-9">
                                    <input
                            ...
                            <div class="form-group row">
                                <x-forms.label name="instamojo secret" class="col-sm-3" />
                                <div class="col-sm-9">
                                    <input
                ...
                @if (env('MOLLIE_ACTIVE'))
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('settings.payment.update') }}" method="POST"
                            ...
                            <div class="form-group row">
                                <x-forms.label name="{{ __('mollie key') }}" class="col-sm-3" />
                                <div class="col-sm-9">
        ...
        <div class="col-sm-6">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('stripe settings') }}</h3>
                        <div class="form-group row">
                ...
                @if (env('STRIPE_ACTIVE'))
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('settings.payment.update') }}" method="POST"
                            ...
                            <div class="form-group row">
                                <x-forms.label name="{{ __('publisher key') }}" class="col-sm-3" />
                                <div class="col-sm-9">
            ...
            {{-- <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('razorpay settings') }}</h3>
                        <div class="form-group row">
            ...
            {{-- <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('paystack settings') }}</h3>
                        <div class="form-group row">
                ...
                @if (env('PAYSTACK_ACTIVE'))
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('settings.payment.update') }}" method="POST"
                            ...
                            <div class="form-group row">
                                <x-forms.label name="{{ __('merchant email') }}" class="col-sm-3" />
                                <div class="col-sm-9">
                                    <input
            ...
            {{-- <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('midtrans setting') }}</h3>
                        <div class="form-group row">
                ...
                @if (env('MIDTRANS_ACTIVE'))
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('settings.payment.update') }}" method="POST"
                            ...
                            <div class="form-group row">
                                <x-forms.label name="{{ __('merchant id') }}" class="col-sm-3" />
                                <div class="col-sm-9">
                                    <input
                            ...
                            <div class="form-group row">
                                <x-forms.label name="{{ __('client key') }}" class="col-sm-3" />
                                <div class="col-sm-9">
                                    <input
                            ...
                            <div class="form-group row">
                                <x-forms.label name="{{ __('server key') }}" class="col-sm-3" />
                                <div class="col-sm-9">
                                    <input
        ...
        <div class="col-sm-6">
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('apple_pay_settings') }}</h3>
                        <div class="form-group row">
                            <input {{ env('APPLE_PAY_ACTIVE') ? 'checked' : '' }} type="checkbox" name="apple_pay"
                                   data-bootstrap-switch value="1">
                        </div>
                    </div>
                </div>
                @if (env('APPLE_PAY_ACTIVE'))
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('settings.payment.update') }}" method="POST"
                              enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <input type="hidden" value="apple" name="type">
                            <div class="form-group row">
                                <x-forms.label name="{{ __('key') }}" class="col-sm-3" />
                                <div class="col-sm-9">
                                    <input onkeyup="ButtonDisabled('button3', 'apple_pay_key' , '{{ env('APPLE_PAY_KEY') }}')"
                                           value="{{ env('APPLE_PAY_KEY') }}" name="apple_pay_key" type="text"
                                           class="form-control @error('apple_pay_key') is-invalid @enderror" autocomplete="off">
                                    @error('apple_pay_key')
                                    <span class="invalid-feedback" role="alert"><span>{{ $message }}</span></span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                <x-forms.label name="{{ __('secret') }}" class="col-sm-3" />
                                <div class="col-sm-9">
                                    <input
                                    onkeyup="ButtonDisabled('button3', 'apple_pay_secret' , '{{ env('APPLE_PAY_SECRET') }}')"
                                    value="{{ env('APPLE_PAY_SECRET') }}" name="apple_pay_secret" type="text"
                                    class="form-control @error('apple_pay_secret') is-invalid @enderror"
                                    autocomplete="off">
                                    @error('apple_pay_secret')
                                    <span class="invalid-feedback" role="alert"><span>{{ $message }}</span></span>
                                    @enderror
                                </div>
                            </div>
