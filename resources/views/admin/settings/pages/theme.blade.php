...
@section('website-settings')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title" style="line-height: 36px;">{{ __('website theme style') }}</h3>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-3">
                    <div class="card">
                        <div class="card-header">{{ __('primary color') }}</div>
                        <div class="card-body">
                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-header">{{ __('secondary color') }}</div>
                        <div class="card-body">
    ...
    <div class="row">
        <div class="col-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title" style="line-height: 36px;">{{ __('admin theme style') }}</h3>
                </div>
                <div class="px-4 pt-3 pb-4">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="card">
                                <div class="card-header">{{ __('left sidebar background color') }}</div>
                                <div class="card-body">
                        ...
                        <div class="col-6">
                            <div class="card">
                                <div class="card-header">{{ __('left sidebar text color') }}</div>
                                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="card">
                                <div class="card-header">{{ __('top nav text color') }}</div>
                                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="card">
                                <div class="card-header">{{ __('main color') }}</div>
                                <div class="card-body">
                        ...
                        <div class="col-6">
                            <div class="card">
                                <div class="card-header">{{ __('accent color') }}</div>
                                <div class="card-body">
        ...
        <div class="col-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title" style="line-height: 36px;">{{ __('layout setting') }} </h3>
                </div>
                <div class="px-4">
                    <div class="row pt-3 pb-4">
                        ...
                        <div class="col-6">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title m-0">{{ __('left navigation layout') }}</h5>
                                </div>
                        ...
                        <div class="col-6">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title m-0">{{ __('top navigation layout') }}</h5>
                                </div>
                                <img style="width: 250px; height: auto"
