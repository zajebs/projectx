                        ...
                        <div class="row ">
                            <div class="col-6">
                                <div class="form-group">
                                    <label class="" for="site_name"> {{ __('site name') }} </label>
                                    <input value="{{ config('app.name') }}" name="name" type="text"
                                        class="form-control " placeholder="{{ __('enter') }} {{ __('site name') }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-md-4">
                                <x-forms.label name="{{ __('white logo') }}" />
                                <input type="file" class="form-control dropify"
            ...
            {{-- <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('recaptcha configuration') }}
                        </h3>
                ...
                @if (config('captcha.active'))
                    <form id="recaptchaForm" class="form-horizontal" action="{{ route('settings.recaptcha.update') }}"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <x-forms.label name="nocaptcha secret" class="col-sm-5" />
                                <div class="col-sm-7">
                            ...
                            <div class="form-group row">
                                <x-forms.label name="nocaptcha sitekey" class="col-sm-5" />
                                <div class="col-sm-7">
                ...
                <div class="card-body">
                    <form action="{{ route('settings.system.update') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            {{-- <div class="col-6">
                                <div class="form-group">
                                    <label class="" for="admin_commission"> {{ __('Admin commission percentage on sale') }} </label>
                                    <input value="{{ $setting->admin_commission }}" name="admin_commission" type="text"
                                        class="form-control " placeholder="{{ __('enter') }} {{ __('admin commission') }}">
                                </div>
                            </div> --}}
                            ...
                            <div class="col-6">
                                <x-forms.label name="{{ __('app debug') }}" />
                                <div>
                            ...
                            <div class="col-6">
                                {{-- <x-forms.label name="{{ __('set default language') }}" />
                            ...
                            <div class="col-6">
                                <x-forms.label name="{{ __('frontend language switcher') }}" :required="true" />
                                <div>
                            ...
                            <div class="col-6">
                                <x-forms.label name="{{ __('set default currency') }}" for="inlineFormCustomSelect" />
                                <select name="currency" class="custom-select mr-sm-2" id="inlineFormCustomSelect">
                                    ...
                                    @foreach ($currencies as $key => $currency)
                                        <option @if($currency->default_currencies == 1) selected @endif
                                            value="{{ $currency->id }}">
                            ...
                            <div class="col-6">
                                {{-- <x-forms.label name="{{ __('customer email verification') }}" :required="true" />
                                <div>
            ...
            <!-- Watermark -->
             <div class="card">
                <form id="watermarkForm" class="form-horizontal"
                    ...
                    <div class="card-header">
                        <div class="d-flex justify-content-between">
                            <h3 class="card-title" style="line-height: 36px;">{{ __('watermark on ads images') }}
                            </h3>
                            <div class="form-group row">
