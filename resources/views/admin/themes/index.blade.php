            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('change home page skin') }}</h3>
                    </div>
                    <div class="card-body">
                        <div class="row justify-content-center">
                            <div class="col-sm-12 col-md-6 col-xl-4">
                                <div class="card d-inline-block">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">{{ __('home page 1') }}</h5>
                                        <p class="card-text">{{ __('home page1 description') }}</p>
                                        @if (homePageThemes() == 1)
                            ...
                            <div class="col-sm-12 col-md-6 col-xl-4">
                                <div class=" card d-inline-block">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">{{ __('home page 2') }}</h5>
                                        <p class="card-text">{{ __('home page2 description') }}</p>
                                        @if (homePageThemes() == 2)
                                            <button onclick="homePageChange(1)" type="submit"
                                                class="btn btn-danger">{{ __('deactivate') }}</button>
                                        @else
                            ...
                            <div class="col-sm-12 col-md-6 col-xl-4">
                                <div class="card d-inline-block">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">{{ __('home page 3') }}</h5>
                                        <p class="card-text">{{ __('home page3 description') }}</p>
                                        @if (homePageThemes() == 3)
                                            <button onclick="homePageChange(1)" type="submit"
                                                class="btn btn-danger">{{ __('deactivate') }}</button>
                                        @else
