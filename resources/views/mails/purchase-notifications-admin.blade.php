                                ...
                                <td class="logo" style="text-align: left;">
                                    <h1>
                                        <a href="{{route('frontend.index')}}">
                                            <img src="{{getPhoto($data['setting']->logo_image)}}" alt="{{getPhoto($data['setting']->logo_image)}}}}"
                            ...
                            <tr>
                                <td style="padding: 0 2.5em; text-align: left;">
                                    <div class="text">
                                        ...
                                        <h3>{{$data['user']->name}} purchase product form  {{$data['owoner']}}</h3>
                                    </div>
                                </td>
                            </tr>
                        </table>
                    ...
                    <table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0"
                        ...
                        <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                            <td valign="middle" width="80%" style="text-align:left; padding: 0 2.5em;">
                                <div class="product-entry">
                                    <img src="{{getPhoto($data['adDetails']->thumbnail)}}" alt="{{getPhoto($data['adDetails']->thumbnail)}}"
                                        style="width: 100px; max-width: 600px; height: auto; margin-bottom: 20px; display: block;">
                                    <div class="text">
                                        <h3>{{$data['adDetails']->title}}</h3>
                                        <span style="font-weight: bold;">Size : {{$data['adDetails']->adSize->size}}</span>
                                        <p style="font-weight: bold;">Color : {{$data['adDetails']->adColor->color}}</p>
                                    </div>
                                </div>
                            </td>
                            <td valign="middle" width="20%" style="text-align:right; padding: 0 2.5em;">
                                <span class="price" style="color: #000; font-size: 20px;">{{$data['adDetails']->price}}</span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td valign="middle" style="text-align:left; padding: 1em 2.5em;">
                                <p><a href="{{ route('frontend.adlist') }}" class="btn btn-primary">Continue to your order</a></p>
                            </td>
                        </tr>
                    </table>
                </tr><!-- end tr -->
                                        ...
                                        <tr>
                                            <td style="text-align: left; padding-left: 10px;">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="{{ route('frontend.adlist') }}">Shop</a></li>
