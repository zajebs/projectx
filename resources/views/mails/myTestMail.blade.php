...
<html>
<head>
    <title>You have a new query from 2live.lv</title>
</head>
<body>
        ...
        <tbody>
            <tr>
                <td width="100%" align="center" valign="top" bgcolor="#E4E6E9" style="background-color:#E4E6E9; min-height: 200px;">
                    <table>
                        <table class="header-row" width="378" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed; text-align: center; margin-bottom: 5px; margin-top: 30px; margin-left: 150px;">
                            <tbody>
                                <tr>
                                    <td class="header-row-td" style="font-family: Arial, sans-serif; font-weight: normal; line-height: 19px; color: #2D3748; margin: 0px; font-size: 25px; padding-bottom: 10px; text-aling: center; margin-left: 100px;" valign="top" align="left"> 2life.lv </td>
                                </tr>
                            </tbody>
                        </table>
                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="table-col-td" width="378" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 378px;" valign="top" align="left">
                                                                    <table class="header-row" width="378" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td class="header-row-td" width="378" style="font-family: Arial, sans-serif; font-weight: bold; line-height: 19px; color: #2D3748; margin: 0px; font-size: 18px; padding-bottom: 10px; padding-top: 15px; text-aling: center; margin: 0 auto;" valign="top" align="left">Hello {{ $details['customer']}} !</td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                    <table class="header-row" width="378" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td class="header-row-td" width="378" style="font-family: Arial, sans-serif; font-weight: normal; line-height: 19px;  margin: 0px; padding-bottom: 10px; padding-top: 15px;" valign="top" align="left">
                                                                                    <b style="color: #2D3748; font-size: 18px;">Subject: </b>
                                                                                    <br>
                                                                    ...
                                                                    <div style="font-family: Arial, sans-serif; line-height: 20px; ">
                                                                        <b style="color: #2D3748;  font-size: 18px;">
                                                                            Message:
                                                                        </b>
                                                                        <br>
                                                                        <p style="color: #777777;  font-size: 14px;">
                                                            ...
                                                            <tr>
                                                                <td class="table-col-td" width="378" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 378px;" valign="top" align="left">
                                                                    <div style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; text-align: center;">
                                                                        <a href="javascript:;" style="color: #ffffff; text-decoration: none; margin: 0px; text-align: center; vertical-align: baseline;  padding: 4px 9px; font-size: 15px; line-height: 21px; font-weight: bold; color: #2D3748;">&nbsp; Thank you &nbsp;</a>
                                                                    </div>
