    ...
    <div class="dashboard__navigation-top">
        <div class="dashboard__user-proifle">
            <div class="dashboard__user-img">
                <img src="{{ getPhotoAvater($user->image) }}" alt="user-photo" />
            </div>
            <div class="dashboard__user-info">
                ...
                <p class="rating">
                    ...
                    <span>{{ $rating_details['average'] }} {{ __('star rating') }}</span>
                </p>
            </div>
        </div>
        <hr>
                        ...
                        <span class="icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <path
                                    ...
                                    stroke="#070707" stroke-width="1.6" stroke-linecap="round"
                ...
                <li class="dashboard__nav-item">
                    <a href="mailto:{{ $user->email }}" class="seller-dashboard__nav-link">
                        <span class="icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M21 5.25L12 13.5L3 5.25" stroke="#070707" stroke-width="1.6"
                                    stroke-linecap="round" stroke-linejoin="round" />
                                <path
                                    d="M3 5.25H21V18C21 18.1989 20.921 18.3897 20.7803 18.5303C20.6397 18.671 20.4489 18.75 20.25 18.75H3.75C3.55109 18.75 3.36032 18.671 3.21967 18.5303C3.07902 18.3897 3 18.1989 3 18V5.25Z"
                                    stroke="#070707" stroke-width="1.6" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path d="M10.3637 12L3.23132 18.5381" stroke="#070707" stroke-width="1.6"
                                    stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M20.7688 18.5381L13.6364 12" stroke="#070707" stroke-width="1.6"
                                    stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <div>
                                ...
                                <label class="form-label" for="note">{{ __('Subject') }}</label>
                                <input type="text" name="note" id=""
                                    placeholder="Please leave a note">
                            </div>
                            <div>
                                <label class="form-label" for="reasonn">{{ __('Explain Reason') }}</label>
