...
@section('title')
    '{{ $subcategory->name }}' {{ __('category wise') }} {{ __('ads') }}
@endsection
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('subcategory details') }}</h3>
                    </div>
                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                <tbody>
                                    ...
                                    @if ($subcategory->subcategories_count)
                                        <tr class="mb-5">
                                            <th width="20%">{{ __('subcategories count') }}</th>
                                            <td width="80%">
