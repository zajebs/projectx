            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('ad details') }}</h3>
                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                <tbody>
                                    ...
                                    <tr class="mb-5">
                                        ...
                                        <td width="80%">{{ onlyCurrencySymbol() }} {{ $ad->price }}</td>
                                    </tr>
                                    <tr class="mb-5">
                                    ...
                                    <tr class="mb-5">
                                        <th width="20%">{{ __('total views') }}</th>
                                        <td width="80%">{{ $ad->total_views }}</td>
                                    </tr>
                                    <tr class="mb-5">
                                        <th width="20%">{{ __('ad link') }}</th>
                                        <td width="80%"><a target="_blank"
                                                href="{{ route('frontend.addetails', $ad->slug) }}">{{ __('go to link') }}</a>
                                        </td>
                                    </tr>
                                    <tr class="mb-5">
