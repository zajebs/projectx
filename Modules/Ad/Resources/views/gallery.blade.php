            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header text-dark d-flex justify-content-between align-items-center">
                        <h6 class="d-inline mb-2"> {{ __('gallery add') }}</h6>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="card-body">
                        <table class="table table-bordered  text-center mb-3">
                            <thead class="text-dark">
                                <tr>
                                    <th width="5%">{{ __('sl') }}</th>
                                    <th width="15%">{{ __('ad title') }}</th>
                                    <th width="10%">{{ __('Gallery Image') }}</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <form action="{{ route('module.ad.delete_gallery', $gallery->id) }}"
                                                    ...
                                                    @method('DELETE')
                                                    @csrf
                                                    <button title="{{ __('delete product') }}"
                                                        onclick="return confirm('{{ __('are you sure') }}?');" class="btn bg-danger"><i
