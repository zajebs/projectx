            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('create custom field') }}</h3>
                        <div>
                            <a href="{{ route('module.custom.field.group.index') }}" class="btn btn-info">
                                <i class="fas fa-cog"></i>
                                <span class="ml-1">{{ __('manage group') }}</span>
                            </a>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group d-none" id="multiple_values">
                                            ...
                                            <select name="values[]"
                                                ...
                                                data-placeholder="{{ __('enter new value') }}" style="width: 100%;">
                                            </select>
                                            @error('values')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
