                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h3 class="card-title" style="line-height: 36px;">{{ __('sorting custom fields') }}</h3>
                            <div>
                                <a href="{{ route('module.ad.index', $ad->id) }}" class="mr-2 btn btn-secondary">
                                    <i class="fas fa-arrow-left"></i>
                                    <span class="ml-2">{{ __('ad list') }}</span>
                                </a>
                                    ...
                                    <tr>
                                        <td colspan="10" class="text-center">
                                            <div class="empty py-5">
                                                ...
                                                <h5 class="mt-4">{{ __('no results found') }}</h5>
                                                <p class="empty-subtitle text-muted">
                                                    {{ __('there_is_no') }} {{ __('found in the page') }}
                                                </p>
