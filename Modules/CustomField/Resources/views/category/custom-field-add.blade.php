        ...
        <div class="row">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h3 class="card-title" style="line-height: 36px;">{{ __('add custom field') }} ⇨
                                {{ $category->name }}</h3>
                            <span class="d-flex">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="type" id="type"
                                            ...
                                            <option {{ old('type') == 'checkbox_multiple' ? 'selected' : '' }}
                                                value="checkbox_multiple">{{ __('checkbox multiple') }}
                                            </option>
                                    ...
                                    <div class="form-group d-none" id="multiple_values">
                                        ...
                                        <select name="values[]" class="valueselect @error('values') is-invalid @enderror"
                                            multiple="multiple" taggable data-placeholder="{{ __('enter new value') }}"
                                            style="width: 100%;">
                                        </select>
                                        @error('values')
                                            <span class="invalid-feedback">{{ $message }}</span>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h3 class="card-title" style="line-height: 36px;">{{ __('attach custom field') }} ⇨
                                {{ $category->name }}</h3>
                        </div>
                    </div>
                    <div class="card-body">
