...
@section('content')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('create post') }}</h3>
    ...
    <div class="col-sm-10">
        <input value="{{ old('title_lv') }}" name="title_lv" type="text"
               ...
               placeholder="{{ __('enter post title in Latvian') }}">
        @error('title_lv')
            <span class="invalid-feedback"
                  role="alert"><strong>{{ $message }}</strong></span>
        @enderror
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9 text-center">
                                                <button type="submit" class="btn btn-success"><i
                                                        class="fas fa-plus"></i>&nbsp;{{ __('create post') }}</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3 text-center">
                                        ...
                                        <div class="upload-btn-wrapper mt-3">
                                            ...
                                            <button onclick="$('#hiddenImgInput').click()" class="btn btn-info"
                                                type="button">{{ __('choose an image') }}</button>
                                        </div>
                                        @error('image')
