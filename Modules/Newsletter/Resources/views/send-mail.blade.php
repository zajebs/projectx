                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-8">
                                <h3>{{ __('send mail') }}</h3>
                                <p>
                                    {{ __('you can send a mail to multiple email addresses') }}
                                </p>
                            </div>
                            <div class="col-md-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('module.newsletter.submit_mail') }}" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="emails[]" class="select2bs4 @error('emails') is-invalid @enderror"
                                        style="width: 100%;" multiple data-placeholder="{{ __('start typing for search') }}"
                                        required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="subject" class="form-control" value="{{ old('subject') }}"
                                        placeholder="{{ __('write the subject here') }}" required>
                                    @error('subject')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="editor2" type="text" class="form-control" name="body" required>
                                        {{ old('body') }}
                                    </textarea>
                                    @error('body')
                                        <span class="invalid-feedback">{{ $message }}</span>
