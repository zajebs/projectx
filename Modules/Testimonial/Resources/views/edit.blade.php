            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('edit testimonial') }}</h3>
                    ...
                    <div class="row pt-3 pb-4">
                        <div class="col-md-5 offset-md-3">
                            <form class="form-horizontal"
                                ...
                                <div class="form-group row">
                                    <x-forms.label name="change image" class="col-sm-3" />
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea rows="8" type="text" class="form-control" name="description"
                                            placeholder="{{ __('write description of testimonial') }}... ">{{ $testimonial->description }}</textarea>
                                        @error('description')
