                    ...
                    <div class="d-flex align-items-center mb-2">
                        <form action="{{ route('module.plan.recommended') }}" method="POST" class="mr-4">
                            ...
                            <div class="form-row align-items-end">
                                <div class="col-auto">
                                    <x-forms.label name="set recommended package" for="inlineFormCustomSelect"
                                        class="mr-sm-2" />
                        ...
                        <form action="{{ route('module.plan.subscription') }}" method="POST">
                            ...
                            <div class="form-row align-items-end">
                                <div class="col-auto">
                                    <x-forms.label name="default subscription type" for="inlineFormCustomSelect"
                                        class="mr-sm-2" />
                ...
                <div class="col-md-12">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <p class="plan-p">{{ __('there is no plan found in this page') }}.</p>
                            @if (userCan('plan.create'))
                                <a href="{{ route('module.plan.create') }}" class="plan-btn">
                                    {{ __('add your first plan') }}
                                </a>
                            @endif
                        </div>
                    </div>
