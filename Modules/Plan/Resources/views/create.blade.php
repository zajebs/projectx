            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('create plan') }}</h3>
                    ...
                    <div class="card-body">
                        <form action="{{ route('module.plan.store') }}" method="POST">
                            ...
                            <div class="row">
                                @if ($setting->subscription_type == 'recurring')
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <x-forms.label name="plan type" required="true" for="ad_limit"
                                                for="plan_type" />
                                    ...
                                    <div class="col-md-6 d-none" id="interval_date">
                                        <div class="form-group">
                                            <x-forms.label name="interval days" required="true"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <x-forms.label name="ad limit" required="true" for="ad_limit" />
                                        <input type="number" id="ad_limit" name="ad limit"
                                            value="{{ old('ad_limit') }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <x-forms.label name="featured limit" required="true" for="featured_limit" />
