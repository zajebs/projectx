...
@section('title') {{ __('create') }} @endsection
...
@section('content')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('create') }}</h3>
                        ...
                        <div class="col-md-6 offset-md-3">
                            <form class="form-horizontal" action="{{ route('module.faq.store') }}" method="POST">
                                ...
                                <div class="form-group row mb-15">
                                    <label class="col-sm-3 form-label">{{ __('select one') }}<small
    ...
    <div class="col-sm-9">
        <input value="{{ old('question_lv') }}" name="question_lv" type="text"
    ...
    <div class="col-sm-9">
        <textarea id="editor3" type="text" class="form-control" name="answer_lv"
            placeholder="{{ __('Answer in Latvian') }}... ">{{ old('answer_lv') }}</textarea>
        @error('answer_lv') 
