            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('faq category list') }}</h3>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="10" class="text-center">
                                            @if (userCan('faq.create'))
                                                <x-admin.not-found word="{{ __('faq category') }}"
                                                    route="module.faq.category.create" />
                                            @else
                                                <x-admin.not-found word="{{ __('faq category') }}" route="" />
                                            @endif
                                        </td>
                                    </tr>
                                @endforelse
