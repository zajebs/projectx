...
class SettingsController extends Controller
{
    ...
    public function systemUpdate(Request $request)
    {
        ...
        if ($request->has('currency')) {
            ...
            Currency::where('id', $request->currency)->update([
        ...
        $setting->language_changing = $request->language_changing ? true : false;
    ...
    public function websiteConfigurationUpdate(Request $request)
    {
        ...
        $setting->deals_under_price=$request->deals_under_price;

        $setting->facebook=$request->facebook;
        $setting->instagram=$request->instagram;
        $setting->gmail=$request->gmail;
        $setting->tiktok=$request->tiktok;
        $setting->ad_valid_day=$request->ad_valid_day;
        $setting->fa_pixel_id=$request->fa_pixel_id;
        $setting->fb_app_id=$request->fb_app_id;
        $setting->google_analytical_id=$request->google_analytical_id;
