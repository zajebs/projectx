...
class CmsSettingController extends Controller
{
    public function index()
    {
        ...
        return view('admin.settings.pages.cms', compact('cms'));
    }
    ...
    public function postingRulesUpdate(Request $request)
    {
        ...
        if ($request->hasFile('posting_rules_background') && $request->file('posting_rules_background')->isValid()) {
            ...
            $cms->update($request->only('posting_rules_body', 'rules_body_lt'));
        }
    ...
    public function updateAbout(Request $request)
    {
        ...
        //     'about_body_lt' => $request->about_body_lt,
        //     'about_body' => $request->about_body,
        // ]);

        $rules = ['about_body'    =>  ['required']];

        $data = $request->only(['about_body', 'about_body_lt']);
    ...
    public function updateTerms(Request $request)
    {
        ...
        if ($request->hasFile('terms_background') && $request->file('terms_background')->isValid()) {
            ...
            $cms->update($request->only('terms_body', 'terms_body_lt'));
        }
    ...
    public function updatePrivacy(Request $request)
    {
        ...
        if ($request->hasFile('privacy_background') && $request->file('privacy_background')->isValid()) {
            ...
            $cms->update($request->only('privacy_body', 'privacy_body_lt'));
        }
    ...
    public function updatedatadeletion(Request $request)
    {
        ...
        $cms->update($request->only('data_deletion', 'data_deletion_lt'));


        return redirect()->back()->with('success', 'Data eletion update successfully!');
